...
export default defineConfig(({ mode }) => {
  ...
  const publicBackendUrl = env.VITE_SUPABASE_URL || "";
  const publicBackendKey = env.VITE_SUPABASE_PUBLISHABLE_KEY || "";
  const publicBackendProjectId = env.VITE_SUPABASE_PROJECT_ID || "";
