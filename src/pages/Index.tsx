...
const Index = () => {
  return (
    <div>
      <SEO
        title="চন্দনাইশ দরবার শরীফ | সরাসরি ওরশ ও আধ্যাত্মিক কেন্দ্র"
        description="চন্দনাইশ দরবার শরীফ - গৌছে জামান হযরত ছৈয়দ মাওলানা আবদুল লতিফ শাহ্ চন্দনাইশী মাইজভান্ডারী (রাঃ) এর পবিত্র দরবার শরীফ। সরাসরি ওরশ, মাহফিল, হাদিয়া ও সুফিবাদের আধ্যাত্মিক শিক্ষা।"
