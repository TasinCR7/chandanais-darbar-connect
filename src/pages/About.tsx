...
const About = () => {
  ...
  return (
    <>
      <SEO 
        title="দরবার পরিচিতি ও গাউছে জামানের জীবনী" 
        description="গাউছে জামান হযরত ছৈয়দ মাওলানা আবদুল লতিফ শাহ চন্দনাইশী মাইজভান্ডারী (ক:) এর বিস্তারিত জীবনী, শিক্ষাজীবন, অলৌকিক কারামত ও চন্দনাইশ দরবার শরীফ প্রতিষ্ঠার ইতিহাস।" 
        keywords="গাউছে জামান জীবনী, আবদুল লতিফ শাহ, চন্দনাইশ দরবার পরিচিতি, মাইজভান্ডারী অলিয়া, সুফি জীবনী, চন্দনাইশ ইতিহাস, হযরত ছৈয়দ মাওলানা আবদুল লতিফ শাহ্ চন্দনাইশী, Chandanaish Darbar Sharif History, Sufi saints of Bangladesh"
        canonical="/about" 
      />
