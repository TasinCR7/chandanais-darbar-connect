...
const About = () => {
  ...
  return (
    <>
      <SEO title="দরবার পরিচিতি - গাউছেজামানের জীবনী" description="গাউছেজামান হযরত ছৈয়দ মাওলানা আবদুল লতিফ শাহ চন্দনাইশী মাইজভান্ডারী (ক:) এর বিস্তারিত জীবনী, শিক্ষা, কারামত ও দরবার শরীফ প্রতিষ্ঠার ইতিহাস।" canonical="/about" />
      ...
      <div className="container mx-auto px-4">
        <SectionTitle
          ...
          subtitleClassName="text-2xl md:text-4xl text-cream font-bold mt-8 mb-4 drop-shadow-md leading-tight"
        />
