...
const islamicEvents = [
  { title: "ঈদে মিলাদুন্নবী (সাঃ)", date: "১২ রবিউল আউয়াল" },
  { title: "বিশেষ মাহফিল", date: "১১ রবিউস সানি" },
  { title: "বিশেষ অনুষ্ঠান", date: "৬ রজব" },
  { title: "বাবা জান কেবলা চন্দনাইশের বার্ষিক অনুষ্ঠান", date: "আরবি মাসের ৩ তারিখ" },
];
