...
const islamicEvents = [
  { title: "ঈদে মিলাদুন্নবী (সাঃ)", date: "১২ রবিউল আউয়াল (২৫ আগস্ট, ২০২৬)" },
  { title: "বিশেষ মাহফিল", date: "১১ রবিউস সানি (২২ সেপ্টেম্বর, ২০২৬)" },
  { title: "বিশেষ অনুষ্ঠান", date: "৬ রজব (১৫ ডিসেম্বর, ২০২৬)" },
  { title: "বাবা জান কেবলা চন্দনাইশের বার্ষিক অনুষ্ঠান", date: "প্রতি আরবি মাসের ৩ তারিখ (পরবর্তী: ২২ মার্চ, ২১ এপ্রিল, ২০ মে, ১৮ জুন, ১৮ জুলাই, ১৬ আগস্ট...)" },
];
